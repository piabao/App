...
import condominio.core.utils.SimpleValidator;
...
//    	DecorationUtils.install(modeloVeiculo, new Decorator(modeloVeiculo, Pos.TOP_RIGHT, new Point2D(100, 0)));
//    	ValidationUtils.install(modeloVeiculo, new SimpleValidator());
    	...
    	modeloVeiculo.textProperty().addListener(new ChangeListener<String>() {
    	    ...
    	    public void changed(final ObservableValue<? extends String> observable, final String oldValue, final String newValue) {
    	    	...
    	    	ObservableList<MODELO> resultadoList = FXCollections.observableList(new ArrayList<MODELO>()); //TODO pCrud.searchModelo(newValue) muitas conexões?
    ...
    private int getIndex(String tipo){
     ...
     public void concluirVeiculo(ActionEvent event){
    	 if(!verificaCampos()){
    		 Dialogs.create().title("Cadastro de Veículos").message("Preencha todos os campos").showError();  		 
    		 return;
    	 }
