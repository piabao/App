...
public class ControleAcessoFxController implements Initializable{
    ...
    public void abrirMapa(MouseEvent ev){
    	((AcessoMapFxController)abrirFXML(ev, "AcessoMap.fxml", "Mapa Condom�nio")).setApp(this);
    }
    ...
    public void sair(ActionEvent event) {
    	...
    	Action response = Dialogs.create().title("Confirma��o").masthead("Liberar Vaga").message("Deseja remover o veiculo desta Vaga?").showConfirm();
